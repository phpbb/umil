...
$lang = array_merge($lang, array(
	...
	'INSTALL_TEST_MOD_CONFIRM'		=> 'Êtes-vous prêt à installer le MOD de test ?',
	...
	'TEST_USERNAME_EXPLAIN'			=> 'Saisissez un nom d’utilisateur ou sélectionnez un nom d’utilisateur dans la fenêtre pop-up sélectionnée.',

	'UNINSTALL_TEST_MOD'			=> 'Désinstaller le MOD de test',
	'UNINSTALL_TEST_MOD_CONFIRM'	=> 'Êtes-vous sûr de vouloir désinstaller le MOD de test ? Tous les réglages et les données sauvegardés par ce MOD seront supprimés !',
	'UPDATE_TEST_MOD'				=> 'Mettre à jour le MOD de test',
	'UPDATE_TEST_MOD_CONFIRM'		=> 'Êtes-vous sûr de vouloir mettre à jour le MOD de test ?',
));
